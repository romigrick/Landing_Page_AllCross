...
export default function FloatingWhatsApp() {
  ...
  useEffect(() => {
    if (!show) return
    const t1 = setTimeout(() => setTooltip(true), 500)
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <div
        className={`relative bg-white text-navy-900 text-sm font-body font-medium rounded-2xl px-4 py-3 shadow-xl border border-gray-100 max-w-[200px] leading-snug transition-all duration-300 ${
      ...
      <button
        ...
        className="w-16 h-16 rounded-full bg-green-500 hover:bg-green-400 flex items-center justify-center shadow-2xl shadow-green-600/40 transition-all duration-200 hover:scale-110 animate-pulse-gold"
        aria-label="Conversar no WhatsApp com um especialista"
      >
